...
const Next = ({ e }) => {
    ...
    return (
        <div className="bg-white mainBox relative rounded-xl p-10">
            ...
            {show.length == 0 && !loading && <Meme e={e} next={next} page={page} setNext={setNext} setPage={setPage}/>}
            {show.length != 0 && !loading && <Meme e={show} next={next} page={page} setNext={setNext} setPage={setPage}/>}
